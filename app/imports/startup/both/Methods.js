 ...
 */
Meteor.methods({
  'Profiles.update'({ name, email, picture, currentClasses, takenClasses, bio, rank }) {
    Profiles.collection.update({ email }, { $set: { name, email, picture, currentClasses, takenClasses, bio, rank } });
  },
});
