      ...
      <Menu style={menuStyle} attached="top" borderless inverted color='dark grey'>
        ...
        {this.props.currentUser ? (
            [<Menu.Item as={NavLink} activeClassName="active" exact to="/add" key='add'>Calender</Menu.Item>,
              ...
              <Menu.Item as={NavLink} activeClassName="active" exact to="/createprofile" key='list'>Profile</Menu.Item>]
        ) : ''}
        ...
        <Menu.Item position="right">
          {this.props.currentUser === '' ? (
            ...
            <Dropdown id="navbar-current-user" text={this.props.currentUser} pointing="top right" icon={'user'}>
              <Dropdown.Menu>
                <Dropdown.Item id="navbar-profile" icon="user" text="Profile" as={NavLink} exact to="/profile" key='profile'/>
